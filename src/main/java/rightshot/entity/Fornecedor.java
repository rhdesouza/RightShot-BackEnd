...
public class Fornecedor extends Auditable<String> {
    ...
    /**
     * Construtor somente para filtro da função de paginação.
     *
     * @param razaoSocial
     * @param nomeFantasia
     * @param cpfCnpj
     */
    public Fornecedor(String razaoSocial, String nomeFantasia, String cpfCnpj) {
        super();
        this.razaoSocial = razaoSocial;
        this.nomeFantasia = nomeFantasia;
        this.cpfCnpj = cpfCnpj;
    ...
    public String getCpfCnpjFormatado() {
        ...
        if (this.getCpfCnpj().length() == 11)
            retorno = this.getCpfCnpj().replaceAll("([0-9]{3})([0-9]{3})([0-9]{3})([0-9]{2})", "$1.$2.$3-$4");
        else
            retorno = this.getCpfCnpj().replaceAll("([0-9]{2})([0-9]{3})([0-9]{3})([0-9]{4})([0-9]{2})", "$1.$2.$3/$4-$5");
